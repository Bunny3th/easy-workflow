    ...
    "definitions": {
        ...
        "model.Node": {
            ...
            "properties": {
                ...
                "isCosigned": {
                    "description": "是否会签  会签的情况下，需要所有人通过才能进行下一节点，只要有一人反对，则退回上一节点",
                    "type": "integer"
                },
                "nodeID": {
                    "description": "节点名称",
                ...
                "userIDs": {
                    "description": "NextNodeIDs []string //下级节点(节点可以有N个直接下级节点)  是否需要下级节点？感觉可以不用。需要，因为生成task时候需要知道下级是谁，或者可以通过计算得知",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
